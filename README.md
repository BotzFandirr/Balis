...
```json
"dependencies": {
    "baileys": "github:Zakzz-Bails/Bail"
}
```
or install in terminal:
```
npm install baileys-mod@github:Zakzz-Bails/Bail
```
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://github.com/Zakzz-Bails/Bail/issues) here.
